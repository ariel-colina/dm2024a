...
CA_catastrophe_base <- function( pinputexps, metodo )
{
  ...
  param_local$meta$script <- "/src/workflow-01/521_CA_reparar_dataset_01.r"
...
FEintra_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/workflow-01/531_FE_intrames.exp3.r"
...
HT_tuning_base <- function( pinputexps, bypass=FALSE)
{
  ...
  param_local$lgb_param <- list(
    ...
    min_gain_to_split = 10, # min_gain_to_split >= 0.0
    min_sum_hessian_in_leaf = 0.001, #  min_sum_hessian_in_leaf >= 0.0
    lambda_l1 = 1000, # lambda_l1 >= 0.0
    lambda_l2 = 1000, # lambda_l2 >= 0.0
