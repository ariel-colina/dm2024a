...
modelo <- rpart(
        ...
        minsplit = 100, # minima cantidad de registros para que se haga el split.0-1000
        minbucket = 50, # tamaño (cantidad de registros) minimo de una hoja. 0-500
        maxdepth = 4 # 1-30
